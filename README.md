Image segmentation is a technique in image processing and computer vision where a digital image is partitioned into multiple segments (discrete groups of pixels). 
